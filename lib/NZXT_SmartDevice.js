    ...
    constructor() {
        ...
        return new Promise((resolve, reject) => {
            ...
            try {
                ...
                reject(new SmartDeviceError("There was an error when accessing the NZXT Smart Device"));
            }
        })
    }
    get HID() {
...
function changeColor(color, mode, speed = 3, size = 3, moving = false, backwards = false, custom = false, i = 0) {
    ...
    try {
        ...
        throw new SmartDeviceError("There was an error when writing to the NZXT Smart Device")
    }
...
class SmartDeviceError extends Error {
    constructor(err = "An error occured") {
        super(err);
        this.name = "SmartDeviceError";
        this.message = err;
        this.deviceID = "nzxt_smartdevice";
        this.deviceName = "NZXT Smart Device";
        Error.captureStackTrace(this, SmartDeviceError)
    }
}
